      ...
      <div className="overflow-hidden rounded-2xl border border-base-300 bg-base-100 shadow-lg">
        ...
        <div className="border-t border-base-300 bg-base-200/40 px-5 py-4 sm:px-8">
          <p className="max-w-3xl text-sm leading-relaxed text-base-content/80">
            ...
            <strong className="text-base-content">Support chat</strong> tab once
            support is unlocked for this order. Video call links are shared in
            that thread; everyone joins using the same link.
          </p>
        </div>
      </div>
        ...
        {!canOpenSupport ? (
          <div role="alert" className="alert alert-warning mt-4 text-sm">
            ...
            <span>
              ...
              <strong className="text-base-content">paid</strong> or confirmed
              as Cash on Delivery, depending on your payment method.
            </span>
          </div>
        ) : null}
